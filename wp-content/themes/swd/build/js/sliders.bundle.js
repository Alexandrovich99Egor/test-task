...
const testimonialsSlider = document.querySelectorAll('.testimonials-section-wrapper__slider');
const milestonesSlider = document.querySelectorAll('.milestones-section-wrapper__slider');
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_0___default()(() => {
  if (testimonialsSlider.length) {
    testimonialsSlider.forEach(testimonialSlider => {
      new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](testimonialSlider, {
  ...
  if (milestonesSlider.length) {
    milestonesSlider.forEach(milestonesSlider => {
      new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](milestonesSlider, {
        modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Pagination],
        slidesPerView: 1,
        spaceBetween: 2,
        navigation: {
